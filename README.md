...
Этот проект представляет собой пробную версию голосового ассистента «Толик». Код создан в рамках дипломного проекта колледжа автоматизации и информационных технологий 20 и пока находится на стадии разработки.
