...
Этот проект представляет собой пробную версию голосового ассистента «Толик». Код создан в рамках дипломного проекта для КАИТ 20 и пока находится на стадии разработки.
